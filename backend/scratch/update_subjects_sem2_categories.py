...
# using the academic categories (BSC, ESC, VSEC, CC, IKS) in the 'type' field.
categorized_data = [
    {
        "code": "24AF1000BS201",
...
print("Updated subject_export2.csv with NEP Category types successfully!")
...
if os.path.exists(export_path):
    ...
    print("Updated subjects_export.csv with NEP Category types successfully!")
...
print(f"MongoDB subjects updated with NEP categories: {updated_count}")
